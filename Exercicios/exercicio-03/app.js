...
const desert = `${dogNames[0].slice(3,5)}${dogNames[1].slice(2,4)}${dogNames[3].slice(2,4)}`.replace('n','d')

// console.log(`'A ${desert} é um doce à base de coco, tradicional na América Latina e em Angola.'`)
