...
console.log( 'Até aqui, o objeto "cat" possui as seguintes propriedades e valores: "name", que recebeu "'  + cat.name +
  '", "age", que recebeu "' + cat.age + ', "color", que recebeu "' + cat.color + 
...
const dog = {
  ...
  age : 7,
  color : 'white',
  bestFriends : ['Viktor' , 'Morgana'],
  sound: function() {return "Au Au"}
}
