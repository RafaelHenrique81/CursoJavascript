...
best2019Movies.forEach(element => {
  sentence += `\n   -${element.title}, dirigido por ${element.directedBy}`
});
...
*/
console.log(Math.trunc(Math.random(0, 10) * 10))