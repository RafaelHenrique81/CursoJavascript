...
*/
const my3FavoriteTVShows = ['Got', 'Stranger Things', 'The Boyz']
...
// console.log(`A string que a "typeSentence" armazena tem mais de ${is39} caracteres? ${String(typeSentence.length > is39).replace('t', 'T').replace('f','F')}.`)
...
/*
  ...
  é: BOOLEAN."
*/
const ages = [31, 81, 61, 11]
const agesSum = ages[0]+ages[1]+ages[3]
